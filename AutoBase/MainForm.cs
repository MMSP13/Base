...
namespace AutoBase
{
    public partial class MainForm : Form
    {
         ...
         private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                AutoBase.Model.Book SendingEngine = new AutoBase.Model.Book { NameRED = "Редактор1", Tel = "999999999", IndexBase = "База", Jornal = "Журнал" };
                AutoBase.Model.Article SendingCar = new AutoBase.Model.Article { Author = "Автор1", Email = "кекпаоа", TemaArticle = "1254876312", idBook = SendingEngine };
                Add(SendingEngine);
            }
            catch (Exception ex)
            {
